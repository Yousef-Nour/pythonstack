...
class Message(models.Model):
    ...
    user = models.ForeignKey(User, related_name="messagesUser", on_delete = models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now = True)

class Comment(models.Model) :
    comment_text = models.TextField(default= 'newComment')
    user =models.ForeignKey(User,related_name="commentUsers",on_delete=models.CASCADE)
    message =models.ForeignKey(Message,related_name="commentOfMessages",on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
